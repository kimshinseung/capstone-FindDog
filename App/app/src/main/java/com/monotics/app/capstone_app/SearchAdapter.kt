...
class SearchAdapter(val searhitem: String, val option: String, val Colname: String): RecyclerView.Adapter<RecyclerView.ViewHolder>() {
    ...
    init {
        ...
        missData.whereEqualTo(option.toString(),searhitem.toString()).addSnapshotListener { querySnapshot, firebaseFirestoreException ->
            misslist.clear()
